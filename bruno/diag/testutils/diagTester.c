...
void diagTest_printNodeConnInfo(diag_moca_node_connect_info_t  *pNodesConnInfo)
{
  int   i,j;
 ...
 * @return None.
 */
void diagTest_Print_Config( 
  MoCA_CONFIG_PARAMS *pCfg, uint32_t showAbsSnrTable, uint32_t rftype)
{
   int i;
 ...
 * @return None.
 */
void diagTest_Print_nodeStatus (PMoCA_NODE_STATUS_ENTRY pNodeStatus, int bitLoading, int header)
{
  MAC_ADDRESS macAddr;
