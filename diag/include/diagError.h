...
#define DIAG_LOG_ROTATE_EXTNUM_SZ      sizeof(uint16_t)

#define DIAGD_LOG_ROTATE_EXTNUM_INDEX (0)
#define DIAGD_MOCA_ERR_COUNTS_INDEX   (DIAGD_LOG_ROTATE_EXTNUM_INDEX + DIAG_LOG_ROTATE_EXTNUM_SZ)
