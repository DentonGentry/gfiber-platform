...
/* hardware band -- these must match the values in bmoca.h */
#define MOCA_HW_BAND_HIGHRF     0
#define MOCA_HW_BAND_MIDRF      1
#define MOCA_HW_BAND_WANRF      2
...
#define MoCA_EXTERNAL_CONTROL               3  /* DEPRECATED */
...
#define MoCA_CONTINUOUS_TX_BAND_ARRAY_SIZE  16
...
#define MoCA_CONTINUOUS_RX_MODE_ATTN_MAX 66
#define MoCA_CONTINUOUS_RX_MODE_ATTN_MIN 3
#define MoCA_DEF_RX_MODE_ATTN            3


#define MoCA_DEF_MID_FREQ_MHZ          575
#define MoCA_DEF_MIDHI_FREQ_MHZ        800
#define MoCA_DEF_WAN_FREQ_MHZ          1000
#define MoCA_DEF_LAN_FREQ_MHZ          1150
#define MoCA_DEF_HBAND_FREQ_MHZ        1000
...
#define MoCA_DEF_BEACON_PWR_REDUCTION  0

#if !defined(DSL_MOCA)
#define MoCA_DEF_BEACON_PWR_REDUCTION_EN  1
#else
#define MoCA_DEF_BEACON_PWR_REDUCTION_EN  0
#endif
...
#define MoCA_MIN_RLAPM_TABLE_PHY       0   
#define MoCA_MAX_RLAPM_TABLE_PHY       255
...
#define MoCA_MAX_RLAPM_EN              2
#define MoCA_DEF_RLAPM_EN              0
#define MoCA_DEF_RLAPM_CAP             3   /** in dBs */
 ...
 * application.
 */
#define MoCA_MAX_INIT_PARAMS                  48
#define MoCA_INIT_PARAM_ALL_MASK              0xFFFFFFFFFFFFLL
...
#define MoCA_INIT_PARAM_RESERVED_INIT_0_MASK          0x00100000LL
   UINT32         reservedInit0; 
...
#define MoCA_INIT_PARAM_RESERVED_INIT_6_MASK          0x01000000LL  // unused, no mmp res1
   UINT32         res6;
...
#define MoCA_INIT_PARAM_PNS_FREQ_MASK_MASK        0x100000000000LL
   UINT32         pnsFreqMask;
#define MoCA_INIT_PARAM_QAM1024_EN_MASK        0x200000000000LL
   UINT32         qam1024En;
#define MoCA_INIT_PARAM_T50_TIME_MIN_MASK         0x400000000000LL
   UINT32         T50TimeMin;
#define MoCA_INIT_PARAM_T50_TIME_MAX_MASK         0x800000000000LL
   UINT32         T50TimeMax;
...
#define MoCA_CFG_PARAM_ALL_MASK               0x03F03FFFFFF7FFFELL

#define MoCA_CFG_NON_LAB_PARAM_ALL_MASK           0x3FFFFFB7FFEELL    /* Due to issue with OutOfOrderLmo and
                                                                 core trace control */

#define MoCA_MAX_SNR_TBL_INDEX                  10
#define MoCA_MAX_SAPM_TBL_50_INDEX              112
#define MoCA_MAX_SAPM_TBL_100_INDEX             240
#define MoCA_MAX_RLAPM_TBL_50_INDEX             66
#define MoCA_MAX_RLAPM_TBL_100_INDEX            66
...
#define MoCA_CFG_PARAM_SNR_MARGIN_MASK                0x00010000LL
   SINT32         snrMarginRs;
   SINT32         snrMarginLdpc;
   SINT32         snrMarginLdpcPre5;
   SINT32         snrMarginOfdma;
...
#define MoCA_CFG_PARAM_SNR_MARGIN_OFFSET_MASK         0x00800000LL
   SINT16         snrMarginRsOffset [MoCA_MAX_SNR_TBL_INDEX];
   SINT16         snrMarginLdpcOffset [MoCA_MAX_SNR_TBL_INDEX];
   SINT16         snrMarginLdpcPre5Offset [MoCA_MAX_SNR_TBL_INDEX];
   SINT16         snrMarginOfdmaOffset [MoCA_MAX_SNR_TBL_INDEX];
...
#define MoCA_CFG_PARAM_SAPM_TABLE_MASK                0x04000000LL
    struct _sapmTable50 {
      UINT8          sapmTableLo[MoCA_MAX_SAPM_TBL_50_INDEX];
      UINT8          sapmTableHi[MoCA_MAX_SAPM_TBL_50_INDEX];
    } sapmTable50;
    struct _sapmTable100 {
      UINT8          sapmTableLo[MoCA_MAX_SAPM_TBL_100_INDEX];
      UINT8          sapmTableHi[MoCA_MAX_SAPM_TBL_100_INDEX];
    } sapmTable100;
#define MoCA_CFG_PARAM_RLAPM_EN_MASK                  0x08000000LL
     UINT32       rlapmEn;
#define MoCA_CFG_PARAM_RLAPM_TABLE_MASK               0x10000000LL
     UINT8        rlapmTable50[MoCA_MAX_RLAPM_TBL_50_INDEX];
     UINT8        rlapmTable100[MoCA_MAX_RLAPM_TBL_100_INDEX];
...
#define MoCA_CFG_PARAM_TARGET_PHY_RATE_20_MASK   0x8000000000LL
      UINT32      targetPhyRate20;
#define MoCA_CFG_PARAM_TARGET_PHY_RATE_20_TURBO_MASK   0x10000000000LL
      UINT32      targetPhyRate20Turbo;
...
#define MoCA_CFG_PARAM_SELECTIVE_RR_MASK           0x40000000000LL
      UINT32      selectiveRR;
#define MoCA_CFG_PARAM_LOOPBACK_EN_MASK            0x80000000000LL
      UINT32      loopbackEn;
#define MoCA_CFG_PARAM_RLAPM_CAP_MASK              0x100000000000LL
      UINT32      rlapmCap50;
      UINT32      rlapmCap100;
#define MoCA_CFG_PARAM_HOST_QOS_MASK              0x200000000000LL
      UINT32      hostQOSEn;
...
typedef struct _MoCAStatus {
   ...
   struct _generalStatus {
     ...
     UINT32       MoCARev;             /**< MoCA HW Revision, 0=MoCA 11, 1=MoCA 11 Lite, 2=Moca 11 Plus, 3=MoCA 20 */
   } generalStatus;
...
#define MoCA_NUM_AGGR_PKT_COUNTS 20
typedef struct _MoCAStatistics {
   /* General Stats */
   struct _generalStats {
     UINT32       inTotalPkts;      /**< Number of total packets sent from this node into the MoCA network */
     UINT32       inTotalBytes;     /**< Number of total bytes sent from this node into the MoCA network */
     ...
     UINT32       inUcUnKnownPkts;  /**< Number of unicast packets sent into the MoCA network destined to an unknown node */
     UINT32       inMcUnKnownPkts;  /**< Number of multicast packets sent into the MoCA network destined to an unknown node */
     UINT32       inUcDiscardPkts;  /**< Number of unicast packets to be sent into the MoCA network that were dropped at ECL layer */
     UINT32       inMcDiscardPkts;  /**< Number of multicast packets to be sent into the MoCA network that were dropped at ECL layer */
     UINT32       inDiscardBufPkts; /**< Number of packets to be sent into the MoCA network that were dropped at MAC layer */
     UINT32       inOctets_low;     /**< Count of octets sent from this node. Lower 32-bits. Upper 32-bits in inOctets_hi */

     UINT32       outTotalPkts;     /**< Number of total packets received by this node out from the MoCA network */
     UINT32       outTotalBytes;    /**< Number of total bytes received by this node out from the MoCA network */
     ...
     UINT32       outMcPkts;        /**< Number of multicast packets received by this node out from the MoCA network */
     UINT32       outUcUnKnownPkts; /**< Number of unicast packets received by this node out from the MoCA network destined to an unknown node */
     UINT32       outMcUnKnownPkts; /**< Number of multicast packets received by this node out from the MoCA network destined to an unknown node */
     UINT32       outUcDiscardPkts; /**< Number of unicast packets received by this node out from the MoCA network in error (i.e. CRC) */
     UINT32       outMcDiscardPkts; /**< Number of multicast packets received by this node out from the MoCA network in error (i.e. CRC) */
     UINT32       outDiscardBufPkts;/**< Number of packets received by this node out from the MoCA network that were dropped at MAC layer */
     ...
     UINT32       aggrPktStatsRxMax;
     UINT32       aggrPktStatsRxCount;
     UINT32       receivedDataFiltered; /**< Count of number of packets filtered due to MC EGR filtering */
     UINT32       lowDropData;          /**< Counts how many packets were dropped on the low-drop mechanism */
   } generalStats;
...
typedef struct _MoCANodeExtendedStatus {
   ...
   UINT32        bitLoading[64];    /**< bits per sub-carrier, 4-bits per sub-carrier */
   UINT32        avgSnr;            /**< in dB */
   UINT32        turbo;
...
typedef struct _MoCANodeStatisticsExtEntry {
   ...
   UINT32        rxLcUcCrcError;
   UINT32        rxLcBcCrcError;
   UINT32        rxLcUcTimeoutError;
   UINT32        rxLcBcTimeoutError;
   UINT32        rxP1Error;
   UINT32        rxP2Error;
   UINT32        rxP3Error;
   UINT32        rxP1GcdError;
...
#define MoCA_PQOS_VLAN_PRIO_DEFAULT    0x5
 ...
 *
 * @param ctx (IN) - A pointer to MoCA context from MoCACtl_Open.
 * @param params (IN)  - A pointer to MoCA_CREATE_PQOS_PARAMS.
 *
 * @return CmsRet enum.
 *         CMSRET_SUCCESS - success
